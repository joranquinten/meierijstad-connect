      ...
      <div className={'ui unstackable grid'}>
        ...
        <div className={'ui four wide right aligned column'} style={{padding: '.8rem 1.4rem 0 0'}}>
          <div className={'icon-container'}>
            ...
            <a href={'https://www.facebook.com/sharer/sharer.php?u=https://www.meierijstadconnect.nl'} target={'_blank'} rel={'noopener noreferrer'}>
            ...
            <a href={"mailto:?body=" + shareText + "&subject=MeierijstadConnect.nl"}>
