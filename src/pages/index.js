          ...
          <div className='ui container'>
            <h1 className='ui header'>
              <div className='content'>
                ...
                In deze tijd gaat alles even anders dan anders. Maar we staan er niet alleen voor. Wij zien overal om ons heen initiatieven ontstaan. Buren die elkaar willen helpen. Met de boodschappen, het opvangen van kinderen of het uitlaten van de hond. En er ontstaan ook ideeën om deze tijd leuker, makkelijker en gezelliger te maken voor iedereen. Op dit platform komen al die mogelijkheden samen. Zo kunnen we elkaar vinden.<br/> <span className="highlighted bold">Meierijstad Connect verbindt ons met elkaar.</span>
                </div>
              </div>
            </h1>
          </div>
