...
module.exports = {
  siteMetadata: {
    ...
    share: {
      text: 'Meierijstad Connect: Verbindt elkaar, help elkaar. 👉 https://www.meierijstadconnect.nl/',
      hashtags: 'Meierijstad Connect,Coronavirus,Blijfveilig,Houdafstand' // separate with commas,
    },
    menuLinks: [
